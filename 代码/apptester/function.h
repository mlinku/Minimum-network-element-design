...
//yeah once, sure
//一般故事都是从定义开始
#define MAX_BUFFER_SIZE 65000000 //默认缓冲的最大大小
...
#define DEFAULT_RECEIVE_SENSITIVITY 30
#define MAX_SEND_DATA 48 * 1024  
#define MAX_SEND 1024  // 发送窗口的大小
#define MAX_NO 128   // 序号上限
#define MAX_RECV 128 // 接收窗口的大小
#define RESEND_TIME 4000 // 超时重传的时间 
...
extern int recvSensitivity; //接收能力
