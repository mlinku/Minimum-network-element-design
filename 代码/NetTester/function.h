...
#define MAX_LEN_ARP 100 //arp表最大长
#define MAX_LEN_R 100  //路由表最大长
#define MAX_METRIC 15 //最大METRIC
#define SEND_TIME 300//缓存发送时间
#define MAX_group 800//分组长度
#define PRINT 0//是否打印信息
#define	ARP_CLOCK 10//ARP重发的最大时间
